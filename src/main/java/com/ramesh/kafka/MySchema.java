...
public class MySchema {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "com.rveerama.kafka.connect.github.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "com.rveerama.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.rveerama.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.rveerama.kafka.connect.github.PrValue";
